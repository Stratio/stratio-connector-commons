...
public abstract class GenericSimpleUpdateFT extends GenericConnectorTest<IConnector>{
    ...
    public void updateGenericsFieldsFT() throws ConnectorException {
        ...
        System.out.println("*********************************** INIT FUNCTIONAL TEST testUpdateFields "+ clusterName.getName() + " ***********************************");
...
//    }
    ...
    private void updateRow(ClusterName clusterName) throws UnsupportedException, ConnectorException {
        ...
        tableMetadataBuilder.addColumn(COLUMN_1, ColumnType.VARCHAR).addColumn(COLUMN_2, ColumnType.BIGINT).addColumn(COLUMN_3, ColumnType.BOOLEAN);
    ...
    private LogicalWorkflow createLogicalWorkFlow() {
        return new LogicalWorkFlowCreator(CATALOG, TABLE, getClusterName()).addColumnName(COLUMN_1, COLUMN_2, COLUMN_3).getLogicalWorkflow();
