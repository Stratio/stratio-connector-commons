...
public abstract class GenericAggregationUpdateFT extends GenericConnectorTest<IConnector>{
    ...
    public void updateAddFunctionFT() throws ConnectorException {
        ...
        System.out.println("*********************************** INIT FUNCTIONAL TEST updateAddFields "+ clusterName.getName() + " ***********************************");
    ...
    protected void verifyUpdate(ClusterName clusterName, int insertedRows, Long valueExpected) throws ConnectorException {
    ...
    private void updateRow(ClusterName clusterName, Operator operator, long value) throws UnsupportedException, ConnectorException {
        ...
        Relation rel2 = getBasicRelation(COLUMN_2,operator, value);
